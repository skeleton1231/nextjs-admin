...
export const apiAdminProduct = (id: string) => `${API_ADMIN_PRODUCTS}/${id}` as const;
...
export const routeAdminProduct = (id: string) => `${ROUTE_ADMIN_PRODUCTS}/${id}` as const;
export const routeAdminProductEdit = (id: string) => `${ROUTE_ADMIN_PRODUCTS}/${id}/edit` as const;
